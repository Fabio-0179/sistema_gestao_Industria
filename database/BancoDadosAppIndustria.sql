...
CREATE TABLE `producao` (
  ...
  CONSTRAINT `producao_ibfk_2` FOREIGN KEY (`id_funcionario`) REFERENCES `funcionario` (`id_funcionario`)
) ENGINE=InnoDB AUTO_INCREMENT=21 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `setor` VALUES (1,'Logística','Roberto'),(2,'Recursos Humanos','Fernanda'),(3,'Tecnologia','Carlos'),(4,'Financeiro','Juliana'),(5,'Marketing','Lucas'),(6,'Diretoria','João');
...
-- Dump completed on 2025-07-15 20:59:25
